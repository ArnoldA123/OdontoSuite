...
/**
 * PR-pagos-05a — CajaPagesAppShellTest. Pins the Apple-language surface for
 * the 2 PAGOS pages plus the payment-method admin form modal:
 *
 ...
 * (PAGOS-MOD-001), admin-CRUD table semantics (PAGOS-A11Y-001), and the
 * `gateway_config` redaction rule (PAGOS-RED-001).
 */
